...
// NOTA: Para operações que exigem permissões elevadas (como leitura de RLS),
// usaríamos a Service Role Key, mas para Auth/CRUD simples, a Anon Key é suficiente.
...
const protect = async (req, res, next) => {
    ...
    // O Supabase verifica se o token é válido, se não expirou, e o decodifica.
